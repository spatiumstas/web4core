export const el = {
    ...
    mihomoDeviceModel: document.getElementById('mihomoDeviceModel'),
    mihomoDeviceModelField: document.getElementById('mihomoDeviceModelField'),
    mihomoTunStackField: document.getElementById('mihomoTunStackField'),
    mihomoTunStackButton: document.getElementById('mihomoTunStackButton'),
    mihomoTunStackText: document.getElementById('mihomoTunStackText'),
    mihomoTunStackMenu: document.getElementById('mihomoTunStackMenu'),
